...
def schedule_next_sequence():
    ...
    sequencer.note(int(now + seqduration * 1 / 2), 0, 60, duration=50, velocity=80, dest=synthSeqID)
    sequencer.note(int(now + seqduration * 2 / 4), 0, 60, duration=50, velocity=80, dest=synthSeqID)
    sequencer.note(int(now + seqduration * 3 / 4), 0, 60, duration=50, velocity=80, dest=synthSeqID)
    sequencer.note(int(now + seqduration * 4 / 4), 0, 60, duration=50, velocity=80, dest=synthSeqID)
    # melody
